...
class Game:
    ...
    def __init__(self, n, top, right, bottom, left):
    ...
    def solve(self):  
        ...
        if self.__solve_rec():
            ...
            print("There is more than 1 solution and the constant boxes are: ")
            for i in range(self.n):
                print(*self.grid[i])
            print("\n", self.griddict)
...
Problem = Game(int(input("Number of Rows and Columns: ")),
                list(map(int, input("Top Side: ").strip().split())),
                list(map(int, input("Right Side: ").strip().split())),
                list(map(int, input("Bottom Side: ").strip().split()))[::-1],
                list(map(int, input("Left Side: ").strip().split()))[::-1])
